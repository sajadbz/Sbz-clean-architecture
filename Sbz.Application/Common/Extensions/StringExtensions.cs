...
namespace Sbz.Application.Common.Extensions
{
    ...
    public static class StringExtensions
    {
        ...
        {
            if (string.IsNullOrEmpty(input)) return input; input = input.Trim().ToLower();
            var htmlSanitizer = new HtmlSanitizer() { AllowedTags = { "a", "div", "p", "br", "pre", "code", "span", "img" }, AllowDataAttributes = true, AllowedAttributes = { "class", "href", "src" } };
            return htmlSanitizer.Sanitize(input);
            //without link
            // var htmlSanitizer = new HtmlSanitizer() {AllowedTags = {"div", "p", "br", "pre", "code", "span"}, AllowDataAttributes = true, AllowedAttributes = {"class"}};
        }
        public static string FixedWithoutToLower(this string input)
        {
            if (string.IsNullOrEmpty(input)) return input; input = input.Trim();
            var htmlSanitizer = new HtmlSanitizer() { AllowedTags = { "a", "div", "p", "br", "pre", "code", "span", "img" }, AllowDataAttributes = true, AllowedAttributes = { "class", "href", "src" } };
            return htmlSanitizer.Sanitize(input);
            //without link
            // var htmlSanitizer = new HtmlSanitizer() {AllowedTags = {"div", "p", "br", "pre", "code", "span"}, AllowDataAttributes = true, AllowedAttributes = {"class"}};
        }
        public static string FixedWithoutTrim(this string input)
        {
        ...
        public static string FixedEmail(this string input)
        {
            return input?.Trim().ToLower().Replace("@", " [at] ");
        }
        ...
        public static string FixUrlForTitle(this string input)
        {
            return string.IsNullOrEmpty(input) ? null : input.ToLower().Trim().Replace("-", " ");
        }
        #endregion
